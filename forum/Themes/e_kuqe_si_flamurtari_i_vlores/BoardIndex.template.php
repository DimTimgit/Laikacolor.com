	...
	<div class="tborder" style="margin-top: ' , $first ? '0;' : '1ex;' , '' , $context['browser']['needs_size_fix'] && !$context['browser']['is_ie6'] ? 'width: 100%;' : '', '">
		...
		<table border="0" width="100%" cellspacing="1" cellpadding="5" class="bordercolor" style="margin-top: 1px;">';
			...
			<tr>
				...
				<td height="18" class="titlebg" valign="middle" align="center" style="width: 5%;">
			...
			<tr>
				...
				<td class="windowbg" valign="middle" align="center" style="width: 12ex;"><span class="smalltext">
					', $board['posts'], ' </span><br /><span class="smalltext">', $txt[21], '</span></td>
				<td class="windowbg" valign="middle" align="center" style="width: 12ex;"><span class="smalltext">
					', $board['topics'],' </span><br /><span class="smalltext">', $txt[330], '</span></td>

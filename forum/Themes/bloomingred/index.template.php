...
<div id="container">
	...
	if ($context['user']['is_logged'])
	{
		if (!empty($context['user']['avatar']))
			echo '
				<p class="avatar" style="float: left; clear: left;" >', $context['user']['avatar']['image'], '</p>';
		echo '
				
					<p>', $txt['hello_member_ndt'], ' <span>', $context['user']['name'], '</span></p>
					<p><a href="', $scripturl, '?action=unread">', $txt['unread_since_visit'], '</a></p>
					<p><a href="', $scripturl, '?action=unreadreplies">', $txt['show_unread_replies'], '</a></p>';
...
// Show a random news item? (or you could pick one from news_lines...)
	if (!empty($settings['enable_news']))
		...
		<div id="newsbar">
		<div id="newsbartxt">
				', $txt['news'], ':  ', $context['random_news_line'], '</div></div></div>';

...
<head>
	...
	foreach (array('ie6', 'opera') as $fixcss)
		if ($context['browser']['is_' . $fixcss])
			echo '
	<link rel="stylesheet" type="text/css" href="', $settings['theme_url'], '/css/', $fixcss, '.css" />';
...
function template_body_above()
{
    ...
    echo '
		...
		if ($context['user']['is_logged'])
		{
			echo '
				<ul class="reset">
					...
					<li><a href="', $scripturl, '?action=unread">&raquo; ' ,$txt['new_topics'] , '</a></li>
					<li><a href="', $scripturl, '?action=unreadreplies">&raquo; ' ,$txt['new_replies'] , '</a></li>';
		...
		echo '
			...
			<img src="'. $settings['images_url']. '/smflogo.png" alt="' . $context['forum_name'] . '" />
		</div>
		<div class="menu_bar">';
...
<div id="wrapper" ' ,!empty($settings['forum_width']) ? 'style="width: ' . $settings['forum_width'] . '"' : 'style="width: 95%;"', '>
	<div id="header"><div class="frame">
		<div id="top_section">
			<h1 class="forumtitle">
				<a href="', $scripturl, '">', empty($context['header_logo_url_html_safe']) ? '<img src="'. $settings['images_url']. '/mylogo.png" alt="' . $context['forum_name'] . '" title="' . $context['forum_name'] . '" />' : '
				<img src="' . $context['header_logo_url_html_safe'] . '" alt="' . $context['forum_name'] . '" title="' . $context['forum_name'] . '" />', '</a>
			</h1>
		</div>
			<div class="searchbox">
	...
	echo '
	<span class="uppersection"><span></span></span>
...
function template_body_below()
{
	...
	<div id="footer_section">
		<ul class="reset">
			...
			<li class="copyright">Pink Floral by <span><a href="http://www.skinmod.eu">Skinmod</a></span></li>
		</ul>';
	...
	<span class="lowersection"><span></span></span>';
}

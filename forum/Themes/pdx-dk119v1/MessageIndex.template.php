...
{
	global $context, $settings, $options, $scripturl, $modSettings, $txt, $colorpath;
	...
	<div class="tborder" style="margin-bottom: 3ex; ', $context['browser']['needs_size_fix'] && !$context['browser']['is_ie6'] ? ' width: 100%;' : '', '">
		...
		foreach ($context['boards'] as $board)
		{
			...
			if ($board['new'])
				echo '<img src="', $settings['images_url'], '/'.$colorpath.'/on.gif" alt="', $txt[333], '" title="', $txt[333], '" />';
			// This board doesn't have new posts, but its children do.
			elseif ($board['children_new'])
				echo '<img src="', $settings['images_url'], '/'.$colorpath.'/on2.gif" alt="', $txt[333], '" title="', $txt[333], '" />';
			// No new posts at all! The agony!!
			else
				echo '<img src="', $settings['images_url'], '/'.$colorpath.'/off.gif" alt="', $txt[334], '" title="', $txt[334], '" />';

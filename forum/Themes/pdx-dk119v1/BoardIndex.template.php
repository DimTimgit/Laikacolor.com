...
{
	global $context, $settings, $options, $txt, $scripturl, $modSettings, $colorpath;
	...
	{
		echo '
	<div class="tborder" style="margin-top: ' , $first ? '0;' : '0' , '' , $context['browser']['needs_size_fix'] && !$context['browser']['is_ie6'] ? 'width: 100%;' : '', '">
		...
		<table border="0" width="100%" cellspacing="1" cellpadding="5" class="bordercolor" style="margin-top: 1px;">';
			...
			<tr>
				...
				if ($board['new'])
					echo '<img class="statpng" src="', $settings['images_url'], '/'.$colorpath.'/on.gif" alt="', $txt[333], '" title="', $txt[333], '" />';
				// This board doesn't have new posts, but its children do.
				elseif ($board['children_new'])
					echo '<img class="statpng" src="', $settings['images_url'], '/'.$colorpath.'/on2.gif" alt="', $txt[333], '" title="', $txt[333], '" />';
				// No new posts at all! The agony!!
				else
					echo '<img class="statpng" src="', $settings['images_url'], '/'.$colorpath.'/off.gif" alt="', $txt[334], '" title="', $txt[334], '" />';
	...
	<table border="0" width="100%" cellspacing="0" cellpadding="5">
		<tr>
			<td align="', !$context['right_to_left'] ? 'left' : 'right', '" class="smalltext">
				<img class="statpng" src="' . $settings['images_url'] . '/'.$colorpath.'/new_some.gif" alt="" align="middle" /> ', $txt[333], '
				<img class="statpng" src="' . $settings['images_url'] . '/'.$colorpath.'/new_none.gif" alt="" align="middle" style="margin-left: 4ex;" /> ', $txt[334], '
			</td>

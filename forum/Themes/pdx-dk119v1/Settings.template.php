...
function template_settings()
{
	...
	$context['theme_settings'] = array(
		...
		array(
			...
			'label' => $txt['theme_default_color'],
			'options' => array(
				'default' => $txt['theme_default_color_default'],
				'blue_dark' => $txt['theme_default_color_blue_b'],
				'green_dark' => $txt['theme_default_color_green_b'],
				'red_dark' => $txt['theme_default_color_red_b'],
				'yellow_light' => $txt['theme_default_color_yellow_w'],
				'blue_light' => $txt['theme_default_color_blue_w'],
				'green_light' => $txt['theme_default_color_green_w'],
				'red_light' => $txt['theme_default_color_red_w'],
			),
		),
		array(
		...
		array(
			'id' => 'pdx_forum_button',
			'label' => $txt['pdx_forum_button'],
			'description' => $txt['pdx_forum_button_desc'],
			'type' => 'text',
		),
		array(
		...
		array(
			'id' => 'top_avatar_resize',
			'label' => $txt['top_avatar_resize'],
		),

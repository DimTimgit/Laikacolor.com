...
function template_theme()
{
	...
	// color selection box						
	if($context['user']['is_logged'] && isset($settings['allow_color_change']) && $settings['allow_color_change'] == 'box')
	{
     echo '
     	<tr>
			<td colspan="2" width="40%"><b>', $txt['theme_personal_color'], ':</b>
			<select name="options[theme_color]" onchange="this.form.submit();">
     			<option selected="selected" value="', $options['theme_color'], '">Use default</option>
     			<option value="default">Yellow / dark</option>
